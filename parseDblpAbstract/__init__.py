...
name = "parseDblpAbstract"
executable_name = "pda"

from .__config__ import *

config: parseDblpAbstractConfig = None
if enable_config:
    config = parseDblpAbstractConfig()

import sys
from QuickProject import user_pip, _ask, external_exec, QproDefaultStatus, QproErrorString, QproWarnString
